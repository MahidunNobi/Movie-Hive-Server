...
import genersRouter from "./Routers/geners";
...
const connect = async () => {
  try {
    await mongoose.connect(
      `mongodb+srv://${process.env.MONGODB_USER}:${process.env.MONGODB_PASSWORD}@cluster0.cxk7yn6.mongodb.net/Movie-Hive?retryWrites=true&w=majority&appName=Cluster0`
    );
